...
import com.iteknical.wednesday.exception.constant.BizResultCode;
...
public class ApiAspect {
    ...
    private final static List<Map<Locale, Map<String, String>>> TRANSLATION_MAP_LIST =
        ImmutableList.of(BizResultCode.TRANSLATION_MAP,
            com.iteknical.fusion.user.exception.constant.BizResultCode.TRANSLATION_MAP,
            ResultCode.TRANSLATION_MAP);
    ...
    private void checkParam(ProceedingJoinPoint pjp) {
        ...
        for (int i = 0; i < parameters.length; i++) {
            ...
            throw new WednesdayException(ResultCode.PARAMETER_INVALID,
